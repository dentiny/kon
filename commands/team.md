...
**WAIT for user confirmation** → 🎶 Yui implements → 📝 Mio reviews.
...
**Testing is manual** — after Mio approves, user runs tests themselves. Different projects have different test setups that are hard to automate reliably.
